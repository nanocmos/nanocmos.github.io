let githubUser = 'nanocmos'
let repo = 'nanocmos.github.io'
...
async function login() {
    ...
    const response = await fetch('https://script.google.com/macros/s/AKfycbwOqjemS4fjeJOevsRRRfymc1-2dWGDhpQGNlc5-nEZcDWAUVSS04_4n0A1VQf8-hpY/exec');
